    ...
    public void paintComponent( Graphics g ) {
        ...
        for ( int x = 0; x < lvl.getArraySizeX(); x++ ) {
            for ( int y = 0; y < lvl.getArraySizeY(); y++ ) {
                ...
                if ( lvl.getArray()[x][y] == 1 ) {
                    g2.drawImage( blueBrick, x * (int) cellSizeX, y * (int) cellSizeY, (int) cellSizeX,
                            (int) cellSizeY, this );
                }

                if ( lvl.getArray()[x][y] == 2 ) {
                    g2.drawImage( redBrick, x * (int) cellSizeX, y * (int) cellSizeY, (int) cellSizeX, (int) cellSizeY,
                            this );

                }

                if ( lvl.getArray()[x][y] == 3 ) {
                    g2.drawImage( goldBrick, x * (int) cellSizeX, y * (int) cellSizeY, (int) cellSizeX,
                            (int) cellSizeY, this );
                }

                if ( lvl.getArray()[x][y] == 4 ) {
                    g2.drawImage( blackBrick, x * (int) cellSizeX, y * (int) cellSizeY, (int) cellSizeX,
                            (int) cellSizeY, this );
                }
        ...
        for ( Mob mob : MobList ) {
            if ( mob.getPath() != null ) {
                for ( int i = 0; i < mob.shortestPath.size(); i++ ) {
                    g2.fillRect( (int) ( mob.getPath().get( i ).getX() * cellSizeX ), (int) ( mob.getPath().get( i )
                            .getY() * cellSizeY ), (int) cellSizeX, (int) cellSizeY );
                }
            }
            g2.drawImage( sorcier, (int) mob.getPosX(), (int) mob.getPosY(), (int) cellSizeX, (int) cellSizeY, this );
        }
        ...
        for ( Player player : PlayerList ) {
            ...
            g2.drawImage(
                    ...
                    (int) player.getPosY(), (int) cellSizeX, (int) cellSizeY, this );
